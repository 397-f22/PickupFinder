...
const UserPage = () => {
    ...
    const userEvents = Object.entries(events).filter(([_, evt]) => evt.attendees.includes(currentUser.uid))
    ...
    return (
        ...
        <h4 className='p-2 text-center'> Welcome back! Keep track of your events here.</h4>
        <Container>
          <Row>
            <Col xs={6}>
